...
const addAuthorName = "K" // add ("author": <addAuthorName>) to module.json if missing (default: "")
...
const addServers = ["https://raw.githubusercontent.com/Kuroine"] // add ("servers": <addServers>) to module.json if missing (default: [""])

const addSupportUrl = "https://github.com/Kuroine" // add ("supportURL": <addSupportURL>) to module.json if missing (default: "")
